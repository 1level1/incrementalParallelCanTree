...
import CanTreeFPGrowth.FreqItemset
import levko.cantree.utils.AssociationRules.Rule
/**
 ...
 *
   * @param freqItemsets frequent itemset model obtained from [[CanTreeFPGrowth]]
